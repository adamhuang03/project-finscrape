...
from similarityFunctionNew2 import generate_related_words
...
class BetakitFundingScraper(BetakitScraper):
    ...
    def __init__(self, url, header, target_string) -> None:
        ...
        print('[In Progress] Gathered articles ...')
        self._ai_filter_articles()
        print('[In Progress] Found important articles ...')
